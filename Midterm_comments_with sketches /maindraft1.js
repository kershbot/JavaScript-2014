var app = app || {}; // app object for the comments 

app.main = (function () { // all the functions and viewing for the app 

var elements ={ // add elements connections to css 
  suggestionField : document.querySelector ('.write-suggestion'), // query selectors is a string containing one or more css selectors 
  suggestionSubmit : document.querySelector ('.submit-suggestion'), //need to mach a css ID / element  
  suggestionList : document.querySelector('.suggestion'), 
  noSuggestionsFound : document.querySelector('.no-comments-found')
}; 
